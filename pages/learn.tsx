    ...
    <Layout>
      ...
      <p className="main__copy">
        <Balancer ratio={0.75}>
          ...
          three repeating daily prompts to set a foundation for your session.
          Followed by two unique prompts that&apos;ll go deeper, explore your
          mind, and differ with each session.
        </Balancer>
      </p>
